 ...
 * |------+------+------+------+------+------++------+------+------+------+------+------|
 * |ExtraR|   A  |   S  |   D  |   F  |   G  ||   H  |   J  |   K  |   L  |   ;  |Enter |
 * |------+------+------+------+------+------||------+------+------+------+------+------|
...
[_QWERTY] = KEYMAP( \
  ...
  MO(_EXTRARIGHT),	   KC_A,       KC_S,    KC_D,       KC_F,           KC_G,            KC_H,       KC_J,           KC_K,     KC_L,    KC_SCLN, KC_ENT , \
...
The keys which are shown empty, like this: |       |, represent a transparent key,
                                           +-------+
meaning thke key from the underlaying layer (i.e. QWERTY) will be used.
 ...
 * |------+------+------+------+------+-------------+------+------+------+------+------|
 * |Enter | Tab  |MousLt|MousDn|MousRt| ...  | PgUp | Left | Down |Right | Tab   |      |
 * |------+------+------+------+------+------|------+------+------+------+------+------|
...
[_CURSORRGHT] = KEYMAP( \
  ...
  KC_ENT,  KC_TAB,           KC_MS_L,      KC_MS_D,      KC_MS_R,      XXXXXXX,             KC_PGDN,  KC_LEFT, KC_DOWN, KC_RGHT, KC_TAB,  _______, \
 ...
 * |------+------+------+------+------+------+-------------+------+------+------+------|
 * | Enter|  Tab |Right | Down | Left | PgUp | xxx  |MousLt|MousDn|MousRt| Tab  |      |
 * |------+------+------+------+------+------+------|------+------+------+------+------|
 * |      | Undo |MsBtRt|MsBtMi|MsBtLe| PgDn | xxx  | Cut  | Copy | Paste| xxx  |      |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      |      |      |      |      |   X  |	    |      |      |      |      |      |
 * `-----------------------------------------------------------------------------------'
 */
[_CURSORLEFT] = KEYMAP( \
  ...
  KC_ENT,  KC_TAB,          KC_LEFT, KC_DOWN, KC_RGHT, KC_PGDN,       XXXXXXX, KC_MS_L,      KC_MS_D,      KC_MS_R,      KC_TAB,  _______, \
  _______, LCTL(KC_Z),      KC_BTN2, KC_BTN3, KC_BTN1, KC_INS,        XXXXXXX, LCTL(KC_DEL), LCTL(KC_INS), LSFT(KC_INS), XXXXXXX, _______, \
  _______, _______,         _______, _______, _______, _______,       _______, _______,      _______,      _______,      _______, _______, \
  _______, _______,         _______, _______, _______, _______,       _______, _______,      _______,      _______,      _______, _______  \
 ...
 * ,-----------------------------------------------------------------------------------.
 * | TAB  | TAB  | TAB  | TAB  |TxBOLT|TxBlt2|   `  |   =  |   (  |   )  |   -  |      |
 * |------+------+------+------+------+-------------+------+------+------+------+------|
 * |******| TAB  | TAB  | TAB  |PLOVR2|PLOVER|      |      |      |      |      |  '   |      |
   This is the
   key turning
   this layer on
 * |------+------+------+------+------+------|------+------+------+------+------+------|
 ...
 */
[_EXTRARIGHT] = KEYMAP( \
  KC_TAB,  KC_TAB,  KC_TAB,  KC_TAB,  STENO_TXBOLT, STENO_TXBOLT2, KC_GRV,  KC_EQL,  KC_LPRN, KC_RPRN, KC_MINS, _______, \
  _______, KC_TAB,  KC_TAB,  KC_TAB,  PLOVER,       PLOVER2,       XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_QUOT, _______, \
  KC_TAB,  KC_TAB,  KC_TAB,  KC_TAB,  XXXXXXX,      XXXXXXX,       XXXXXXX, XXXXXXX, KC_LBRC, KC_RBRC, KC_BSLS, _______, \
  _______, _______, _______, _______, _______,      _______,       _______, _______, _______, _______, _______, _______, \
  _______, _______, _______, _______, _______,      _______,       _______, _______, _______, _______, _______, _______  \
