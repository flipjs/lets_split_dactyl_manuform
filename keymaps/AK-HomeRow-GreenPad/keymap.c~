...
[_QWERTY] = KEYMAP( \
   ...
   XXXXXXX, XXXXXXX,  STN_A,   STN_O,   XXXXXXX, XXXXXXX,   XXXXXXX, XXXXXXX, STN_E,   STN_U,   XXXXXXX, XXXXXXX, \
 ...
 * |------+------+------+------+------+------+-------------+------+------+------+------|
 * | Enter| xxx  | Right| Down | Left | PgUp | xxx  |MousLt|MousDn|MousRt| xxx  |Enter |
 * |------+------+------+------+------+------+------|------+------+------+------+------|
...
[_CURSORLEFT] = KEYMAP( \
  ...
  KC_ENT,  XXXXXXX, 	    KC_LEFT, KC_DOWN, KC_RGHT, KC_PGDN,       XXXXXXX, KC_MS_L,      KC_MS_D,      KC_MS_R,      XXXXXXX, _______, \
...
[_NUMBERS] = KEYMAP( \
  ...
  LT(_EXTRARIGHT,KC_TAB), KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0, _______,    \
